...
void test_validate_my_username()
{
     ...
     */
    const char *c_username = my_username();
    const char *txt_username = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(c_username, txt_username, "C username != txt username");
}
